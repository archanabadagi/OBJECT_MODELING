...
import com.object.modeling.codingame.entities.ScoreWeight;
...
public class ContestService implements IContestService {
    ...
    private List<Question> pickQuestionsList(final List<Question> questions,final Integer numQuestion){
        // if (numQuestion <= 0) {
        //     throw new IllegalArgumentException("Number of questions should be greater than 0.");
        // }
        
        // List<Question> shuffledQuestions = new ArrayList<>(questions);
        // Collections.shuffle(shuffledQuestions);

        // int toPick = Math.min(numQuestion, shuffledQuestions.size());
        // return shuffledQuestions.subList(0, toPick);

...
public class WithdrawContestCommand implements ICommand{
    ...
    public void execute(List<String> tokens) {
        try{
            ...
            System.out.println("RegisterContestDto [contestName="+userRegistrationDto.getContestName()+", registerationStatus="+userRegistrationDto.getRegisterationStatus()+", userName="+userRegistrationDto.getUserName()+"]");
